...
class Program
{
    static void Main(string[] args)
    {
        ...
        while (true)
        {
            ...
            {
                Console.WriteLine("🤖 Bot: Thanks for the chat, stay cyber-smart! 👋");
                break;
            }
    ...
    static void PlayGreetingAudio()
    {
        ...
        {
            Console.WriteLine("⚠️  Bot: Audio greeting could not be played. Ensure 'greeting.wav' exists and 'afplay' is available.");
        }
    }
